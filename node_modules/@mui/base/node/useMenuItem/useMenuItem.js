...
var _DropdownContext = _interopRequireDefault(require("../useDropdown/DropdownContext"));
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = (_React$useContext = React.useContext(_DropdownContext.default)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
  const {
  ...
  function getRootProps(otherHandlers = {}) {
    const getCombinedRootProps = (0, _combineHooksSlotProps.default)(getOwnHandlers, (0, _combineHooksSlotProps.default)(getButtonProps, getListRootProps));
